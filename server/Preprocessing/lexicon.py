...
csv_path = Path(__file__).resolve().parents[1] / 'data' / 'postings.csv'
...
output_path = Path(__file__).resolve().parents[0] / 'lexicon.csv'
vocabulary_df.to_csv(output_path, index=False)
